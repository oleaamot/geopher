...
rm -f lib/Test2/API/InterceptResult.pm
rm -f lib/Test2/API/InterceptResult/Event.pm
rm -f lib/Test2/API/InterceptResult/Facet.pm
rm -f lib/Test2/API/InterceptResult/Hub.pm
rm -f lib/Test2/API/InterceptResult/Squasher.pm
...
rm -f lib/Test2/EventFacet/Info/Table.pm

...
"x86_64-linux-5.4.0-109-generic" or
	die "Errno architecture (x86_64-linux-5.4.0-109-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";

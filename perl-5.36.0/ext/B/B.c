...
XS_EUPXS(XS_B__INVLIST_prev_index); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_B__INVLIST_prev_index)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "invlist");
    {
	B__INVLIST	invlist;
	int	RETVAL;
	dXSTARG;
	...
	if (SvROK(ST(0))) {
	    IV tmp = SvIV((SV*)SvRV(ST(0)));
	    invlist = INT2PTR(B__INVLIST,tmp);
	}
	else
	    croak("invlist is not a reference")
;
#line 1644 "B.xs"
...
XS_EUPXS(XS_B__INVLIST_is_offset); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_B__INVLIST_is_offset)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "invlist");
...
XS_EUPXS(XS_B__INVLIST_array_len); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_B__INVLIST_array_len)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "invlist");
...
XS_EUPXS(XS_B__INVLIST_get_invlist_array); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_B__INVLIST_get_invlist_array)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "invlist");
...
#  endif
        ...
        XSANY.any_i32 = 2;
        newXS_deffile("B::INVLIST::prev_index", XS_B__INVLIST_prev_index);
        newXS_deffile("B::INVLIST::is_offset", XS_B__INVLIST_is_offset);
        newXS_deffile("B::INVLIST::array_len", XS_B__INVLIST_array_len);
        newXS_deffile("B::INVLIST::get_invlist_array", XS_B__INVLIST_get_invlist_array);

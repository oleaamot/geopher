 ...
 * contents of DosGlob.xs. Do not edit this file, edit DosGlob.xs instead.
 *
...
XS_EUPXS(XS_File__DosGlob__callsite); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_File__DosGlob__callsite)
{
    dVAR; dXSARGS;
...
XS_EXTERNAL(boot_File__DosGlob)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("File::DosGlob::_callsite", XS_File__DosGlob__callsite);

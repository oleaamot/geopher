...
XS_EUPXS(XS_attributes__modify_attrs)
{
    ...
    SP -= items;
    {
#line 137 "attributes.xs"
    SV *rv, *sv;
#line 299 "attributes.c"
#line 140 "attributes.xs"
    if (items < 1) {
usage:
...
XS_EUPXS(XS_attributes__fetch_attrs)
{
    ...
    SP -= items;
    {
#line 158 "attributes.xs"
    SV *rv, *sv;
    cv_flags_t cvflags;
#line 333 "attributes.c"
#line 161 "attributes.xs"
    if (items != 1) {
usage:
...
XS_EUPXS(XS_attributes__guess_stash)
{
    ...
    SP -= items;
    {
#line 189 "attributes.xs"
    SV *rv, *sv;
    dXSTARG;
#line 377 "attributes.c"
...
XS_EUPXS(XS_attributes_reftype)
{
    ...
    SP -= items;
    {
#line 236 "attributes.xs"
    SV *rv, *sv;
    dXSTARG;
#line 437 "attributes.c"
#line 239 "attributes.xs"
    if (items != 1) {
usage:
	croak_xs_usage(cv, "$reference");
    }
...
#  endif
        ...
        newXS_deffile("attributes::_modify_attrs", XS_attributes__modify_attrs);

...
#line 509 "FieldHash.c"

XS_EUPXS(XS_Hash__Util__FieldHash__fieldhash); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Hash__Util__FieldHash__fieldhash)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_Hash__Util__FieldHash_id); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Hash__Util__FieldHash_id)
{
    dVAR; dXSARGS;
    if (items != 1)
	...
	SV*	ref = ST(0)
;
#line 391 "FieldHash.xs"
    if (SvROK(ref)) {
        XPUSHs(HUF_obj_id(aTHX_ ref));
    } else {
        XPUSHs(ref);
    }
#line 568 "FieldHash.c"
	PUTBACK;
	return;
    }
}
...
XS_EUPXS(XS_Hash__Util__FieldHash_id_2obj); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Hash__Util__FieldHash_id_2obj)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_Hash__Util__FieldHash_register); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Hash__Util__FieldHash_register)
{
    dVAR; dXSARGS;
    if (items < 1)
...
XS_EUPXS(XS_Hash__Util__FieldHash_CLONE); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Hash__Util__FieldHash_CLONE)
{
    dVAR; dXSARGS;
    if (items != 1)
...
;
#line 435 "FieldHash.xs"
    if (strEQ(classname, "Hash::Util::FieldHash")) {
        HUF_global(aTHX_ HUF_CLONE);
        HUF_fix_objects(aTHX);
    }
#line 648 "FieldHash.c"
    }
    XSRETURN_EMPTY;
}


XS_EUPXS(XS_Hash__Util__FieldHash__active_fields); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Hash__Util__FieldHash__active_fields)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "obj");
...
XS_EUPXS(XS_Hash__Util__FieldHash__test_uvar_get); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Hash__Util__FieldHash__test_uvar_get)
{
    dVAR; dXSARGS;
    dXSI32;
    if (items != 2)
...
XS_EXTERNAL(boot_Hash__Util__FieldHash)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
...

    {
        ...
        newXS_deffile("Hash::Util::FieldHash::CLONE", XS_Hash__Util__FieldHash_CLONE);
        newXS_deffile("Hash::Util::FieldHash::_active_fields", XS_Hash__Util__FieldHash__active_fields);
        cv = newXS_deffile("Hash::Util::FieldHash::_test_uvar_get", XS_Hash__Util__FieldHash__test_uvar_get);
        XSANY.any_i32 = 1;
        cv = newXS_deffile("Hash::Util::FieldHash::_test_uvar_same", XS_Hash__Util__FieldHash__test_uvar_get);
        XSANY.any_i32 = 3;
        cv = newXS_deffile("Hash::Util::FieldHash::_test_uvar_set", XS_Hash__Util__FieldHash__test_uvar_get);
        XSANY.any_i32 = 2;
    }

    /* Initialisation Section */

#line 358 "FieldHash.xs"
{
    HUF_global(aTHX_ HUF_INIT); /* create variables */
}

#line 770 "FieldHash.c"

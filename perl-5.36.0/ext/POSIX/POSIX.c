...
#  endif
        ...
        XSANY.any_i32 = 30;
        cv = newXSproto_portable("POSIX::FLT_ROUNDS", XS_POSIX_fegetround, file, "");
        XSANY.any_i32 = 1;
        cv = newXSproto_portable("POSIX::fegetround", XS_POSIX_fegetround, file, "");
        XSANY.any_i32 = 0;

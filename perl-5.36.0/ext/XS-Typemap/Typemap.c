...
XS_EUPXS(XS_XS__Typemap_T_SV_output); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_XS__Typemap_T_SV_output)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "sv");
...
XS_EUPXS(XS_XS__Typemap_T_SVREF_REFCOUNT_FIXED_output); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_XS__Typemap_T_SVREF_REFCOUNT_FIXED_output)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "svref");
...
XS_EUPXS(XS_XS__Typemap_T_AVREF_REFCOUNT_FIXED_output); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_XS__Typemap_T_AVREF_REFCOUNT_FIXED_output)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "avref");
    {
	AV_FIXED *	avref;
#line 332 "Typemap.xs"
  avref = newAV();
...
XS_EUPXS(XS_XS__Typemap_T_HVREF_REFCOUNT_FIXED_output); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_XS__Typemap_T_HVREF_REFCOUNT_FIXED_output)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "hvref");
    {
	HV_FIXED *	hvref;
#line 361 "Typemap.xs"
  hvref = newHV();
...
XS_EUPXS(XS_XS__Typemap_T_CVREF_REFCOUNT_FIXED_output); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_XS__Typemap_T_CVREF_REFCOUNT_FIXED_output)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "cvref");
    {
	CV_FIXED *	cvref;
#line 390 "Typemap.xs"
...
#line 1468 "Typemap.c"
	XSprePUSH;
	PUSHp((char *)RETVAL, sizeof(*RETVAL));
    }
    XSRETURN(1);
}
...
#  endif
        ...
        newXS_deffile("XS::Typemap::T_SV_output", XS_XS__Typemap_T_SV_output);
        ...
        newXS_deffile("XS::Typemap::T_SVREF_REFCOUNT_FIXED_output", XS_XS__Typemap_T_SVREF_REFCOUNT_FIXED_output);
        ...
        newXS_deffile("XS::Typemap::T_AVREF_REFCOUNT_FIXED_output", XS_XS__Typemap_T_AVREF_REFCOUNT_FIXED_output);
        ...
        newXS_deffile("XS::Typemap::T_HVREF_REFCOUNT_FIXED_output", XS_XS__Typemap_T_HVREF_REFCOUNT_FIXED_output);
        ...
        newXS_deffile("XS::Typemap::T_CVREF_REFCOUNT_FIXED_output", XS_XS__Typemap_T_CVREF_REFCOUNT_FIXED_output);

...
XS_EUPXS(XS_Time__HiRes_utime); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Time__HiRes_utime)
{
    dVAR; dXSARGS;
    if (items < 2)
       croak_xs_usage(cv,  "accessed, modified, ...");
    {
#line 1288 "HiRes.xs"
        SV* accessed;
        SV* modified;
...
XS_EUPXS(XS_Time__HiRes_clock_nanosleep)
{
    ...
    {
	clockid_t    clock_id = (clockid_t)SvIV(ST(0))
;
...
#endif
#if XSubPPtmpAAAJ
        (void)newXSproto_portable("Time::HiRes::utime", XS_Time__HiRes_utime, file, "$$@");
#endif
#if XSubPPtmpAAAK
        (void)newXSproto_portable("Time::HiRes::utime", XS_Time__HiRes_utime, file, "$$;@");
#endif

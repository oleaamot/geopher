...
XS_EUPXS(XS_Data__Dumper_Dumpxs); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Data__Dumper_Dumpxs)
{
    dVAR; dXSARGS;
    if (items < 1)
...
XS_EUPXS(XS_Data__Dumper__vstring); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Data__Dumper__vstring)
{
    dVAR; dXSARGS;
    if (items != 1)
...
#  endif
        ...
        (void)newXSproto_portable("Data::Dumper::_vstring", XS_Data__Dumper__vstring, file, "$");
#if PERL_VERSION_LE(5, 21, 5)

...
#line 7818 "Storable.c"

XS_EUPXS(XS_Storable_init_perinterp); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Storable_init_perinterp)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7691 "Storable.xs"
    init_perinterp(aTHX);
#line 7829 "Storable.c"
    }
    XSRETURN_EMPTY;
}


XS_EUPXS(XS_Storable_pstore); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Storable_pstore)
{
    dVAR; dXSARGS;
    dXSI32;
    if (items != 2)
...
XS_EUPXS(XS_Storable_mstore); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Storable_mstore)
{
    dVAR; dXSARGS;
    dXSI32;
    if (items != 1)
...
XS_EUPXS(XS_Storable_pretrieve); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Storable_pretrieve)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "f, flag = 6");
    {
...
#line 7743 "Storable.xs"
    RETVAL = pretrieve(aTHX_ f, flag);
#line 7906 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_mretrieve); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Storable_mretrieve)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "sv, flag = 6");
    {
	SV*	sv = ST(0)
;
	IV	flag;
...
#line 7752 "Storable.xs"
    RETVAL = mretrieve(aTHX_ sv, flag);
#line 7934 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_dclone); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Storable_dclone)
{
    dVAR; dXSARGS;
    if (items != 1)
...
;
	SV *	RETVAL;
#line 7760 "Storable.xs"
    RETVAL = dclone(aTHX_ sv);
#line 7954 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_last_op_in_netorder); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    dVAR; dXSARGS;
    dXSI32;
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7770 "Storable.xs"
    bool result;
#line 7972 "Storable.c"
#line 7772 "Storable.xs"
    if (ix) {
        dSTCXT;
        assert(cxt);
    ...
    ST(0) = boolSV(result);
#line 7982 "Storable.c"
    }
    XSRETURN(1);
}


XS_EUPXS(XS_Storable_stack_depth); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Storable_stack_depth)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Storable_stack_depth_hash); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Storable_stack_depth_hash)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
#  endif
        ...
        cv = newXSproto_portable("Storable::is_retrieving", XS_Storable_last_op_in_netorder, file, "");
        XSANY.any_i32 = ST_RETRIEVE;
        cv = newXSproto_portable("Storable::is_storing", XS_Storable_last_op_in_netorder, file, "");
        XSANY.any_i32 = ST_STORE;
        cv = newXSproto_portable("Storable::last_op_in_netorder", XS_Storable_last_op_in_netorder, file, "");
        XSANY.any_i32 = 0;
        (void)newXSproto_portable("Storable::stack_depth", XS_Storable_stack_depth, file, "");
        (void)newXSproto_portable("Storable::stack_depth_hash", XS_Storable_stack_depth_hash, file, "");

    /* Initialisation Section */

#line 7669 "Storable.xs"
{

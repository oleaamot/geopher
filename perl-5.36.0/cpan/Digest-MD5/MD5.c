...
XS_EUPXS(XS_Digest__MD5_new); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Digest__MD5_new)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_Digest__MD5_clone); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Digest__MD5_clone)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_Digest__MD5_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Digest__MD5_DESTROY)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_Digest__MD5_add); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Digest__MD5_add)
{
    dVAR; dXSARGS;
    if (items < 1)
       croak_xs_usage(cv,  "self, ...");
...
XS_EUPXS(XS_Digest__MD5_addfile); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Digest__MD5_addfile)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_Digest__MD5_digest); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Digest__MD5_digest)
{
    dVAR; dXSARGS;
    dXSI32;
    if (items != 1)
...
XS_EUPXS(XS_Digest__MD5_context); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Digest__MD5_context)
{
    dVAR; dXSARGS;
    if (items < 1)
    ...
    SP -= items;
    {
	MD5_CTX*	ctx = get_md5_ctx(aTHX_ ST(0))
;
#line 701 "MD5.xs"
	char out[16];
        U32 w;
...
XS_EUPXS(XS_Digest__MD5_md5); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Digest__MD5_md5)
{
    dVAR; dXSARGS;
    dXSI32;
...
#  endif
...

    {
        ...
        newXS_deffile("Digest::MD5::new", XS_Digest__MD5_new);
        newXS_deffile("Digest::MD5::clone", XS_Digest__MD5_clone);
        newXS_deffile("Digest::MD5::DESTROY", XS_Digest__MD5_DESTROY);
        newXS_deffile("Digest::MD5::add", XS_Digest__MD5_add);
        newXS_deffile("Digest::MD5::addfile", XS_Digest__MD5_addfile);
        cv = newXS_deffile("Digest::MD5::b64digest", XS_Digest__MD5_digest);
        XSANY.any_i32 = F_B64;
        cv = newXS_deffile("Digest::MD5::digest", XS_Digest__MD5_digest);
        XSANY.any_i32 = F_BIN;
        cv = newXS_deffile("Digest::MD5::hexdigest", XS_Digest__MD5_digest);
        XSANY.any_i32 = F_HEX;
        newXS_deffile("Digest::MD5::context", XS_Digest__MD5_context);
        cv = newXS_deffile("Digest::MD5::md5", XS_Digest__MD5_md5);
        XSANY.any_i32 = F_BIN;
        cv = newXS_deffile("Digest::MD5::md5_base64", XS_Digest__MD5_md5);
        XSANY.any_i32 = F_B64;
        cv = newXS_deffile("Digest::MD5::md5_hex", XS_Digest__MD5_md5);
        XSANY.any_i32 = F_HEX;
    }
#if PERL_VERSION_LE(5, 21, 5)

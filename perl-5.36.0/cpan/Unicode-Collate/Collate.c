...
#  endif
        ...
        newXS_deffile("Unicode::Collate::_fetch_rest", XS_Unicode__Collate__fetch_rest);
        newXS_deffile("Unicode::Collate::_fetch_simple", XS_Unicode__Collate__fetch_simple);
        cv = newXS_deffile("Unicode::Collate::_exists_simple", XS_Unicode__Collate__ignorable_simple);
        XSANY.any_i32 = 1;
        cv = newXS_deffile("Unicode::Collate::_ignorable_simple", XS_Unicode__Collate__ignorable_simple);
        XSANY.any_i32 = 0;
        newXS_deffile("Unicode::Collate::_getHexArray", XS_Unicode__Collate__getHexArray);
        newXS_deffile("Unicode::Collate::_isIllegal", XS_Unicode__Collate__isIllegal);
        newXS_deffile("Unicode::Collate::_decompHangul", XS_Unicode__Collate__decompHangul);
        newXS_deffile("Unicode::Collate::getHST", XS_Unicode__Collate_getHST);
        cv = newXS_deffile("Unicode::Collate::_derivCE_14", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 1;
        cv = newXS_deffile("Unicode::Collate::_derivCE_18", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 2;
        cv = newXS_deffile("Unicode::Collate::_derivCE_20", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 3;
        cv = newXS_deffile("Unicode::Collate::_derivCE_22", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 4;
        cv = newXS_deffile("Unicode::Collate::_derivCE_24", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 5;
        cv = newXS_deffile("Unicode::Collate::_derivCE_32", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 6;
        cv = newXS_deffile("Unicode::Collate::_derivCE_34", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 7;
        cv = newXS_deffile("Unicode::Collate::_derivCE_36", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 8;
        cv = newXS_deffile("Unicode::Collate::_derivCE_38", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 9;
        cv = newXS_deffile("Unicode::Collate::_derivCE_40", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 10;
        cv = newXS_deffile("Unicode::Collate::_derivCE_43", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 11;
        cv = newXS_deffile("Unicode::Collate::_derivCE_9", XS_Unicode__Collate__derivCE_9);
        XSANY.any_i32 = 0;
        newXS_deffile("Unicode::Collate::_derivCE_8", XS_Unicode__Collate__derivCE_8);
        newXS_deffile("Unicode::Collate::_uideoCE_8", XS_Unicode__Collate__uideoCE_8);
        newXS_deffile("Unicode::Collate::_isUIdeo", XS_Unicode__Collate__isUIdeo);
        newXS_deffile("Unicode::Collate::mk_SortKey", XS_Unicode__Collate_mk_SortKey);
        newXS_deffile("Unicode::Collate::varCE", XS_Unicode__Collate_varCE);
        newXS_deffile("Unicode::Collate::visualizeSortKey", XS_Unicode__Collate_visualizeSortKey);
#if PERL_VERSION_LE(5, 21, 5)

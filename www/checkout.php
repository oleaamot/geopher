...
header("Location: https://www.piperpal.com/?query=" . $_POST['name'] . "&glat=" . $_POST['glat'] . "&location=" . $_POST['location'] . "&glon=" . $_POST['glon'] . "&service=" . $_POST['service'] . "&paid=" . $_POST['paid'] . "#results");
print "<!DOCTYPE html><html lang='en'><head><meta charset='utf-8' />";
print "<meta http-equiv='refresh' content='120; url=https://www.piperpal.com/?query=" . $_POST['name'] . "&glat=" . $_POST['glat'] . "&location=" . $_POST['location'] . "&glon=" . $_POST['glon'] . "&service=" . $_POST['service'] . "&paid=" . $_POST['paid'] . "#results" . "/>";
$db = mysqli_connect("piperpalcom02.mysql.domeneshop.no","piperpalcom02", "Cup-tales-rafta-1920-vispe", "piperpalcom02");

...
if (navigator.geolocation) {
   ...
   <form onsubmit='updateGeo()' id="searchbar-form" method='GET' action='https://api.piperpal.com/location/push.php'>
   ...
   <tr><td><form onsubmit='updateGeo()' action='https://www.piperpal.com/checkout.php' method='POST'>
   <script src='https://checkout.stripe.com/checkout.js' class='stripe-button' data-key='pk_live_51GPZU7DObaLe8ONvW0jGKfT4xjCbVO0YBpL35ZZSpmq1Scf9rBqpRtL3oPlYIdAbvj9VKh3ZbuYI6ZP15D4lSubh00S9Nx9t3X' data-amount='<?php echo $_GET['paid']; ?>' data-name='Aamot Software' data-description='<?php echo $_GET['location']; ?> / <?php echo $_GET['service']; ?> (<?php echo $_GET['paid']; ?>)' data-image='/img/Location_Icon.png'></script></td></tr>
   </table>
  </form>
</body>
</html>
